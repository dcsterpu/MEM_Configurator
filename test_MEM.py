...
class MEMConfigurator(unittest.TestCase):
    ...
    def test_TRS_MEMCFG_INOUT_001(self):
        ...
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.INOUT.001\\ConfigMemConfigurator.xml')
        self.assertTrue(FileCompare.checkParsing(head + '\\tests\\TRS.MEMCFG.INOUT.001\\input', head + '\\tests\\TRS.MEMCFG.INOUT.001\\output\\result.log', '.arxml', 'is well-formed'))

    def test_TRS_MEMCFG_INOUT_002(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.INOUT.002\\ConfigMemConfigurator.xml')
        self.assertTrue(FileCompare.checkParsing(head + '\\tests\\TRS.MEMCFG.INOUT.002\\input', head + '\\tests\\TRS.MEMCFG.INOUT.002\\output\\result.log', '.xml', 'is well-formed'))

    def test_TRS_MEMCFG_FUNC_001_1(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.FUNC.001_1\\ConfigMemConfigurator.xml')
        self.assertTrue(FileCompare.areSorted(head + '\\tests\\TRS.MEMCFG.FUNC.001_1\\output\\NvDM.epc'))

    def test_TRS_MEMCFG_FUNC_001_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.FUNC.001_2\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_FUNC_002_1(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.FUNC.002_1\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_FUNC_002_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.FUNC.002_2\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_CHECK_001_1(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.001_1\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_CHECK_001_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.001_2\\ConfigMemConfigurator.xml')
        ...
        self.assertTrue(FileCompare.checkLog(head + '\\tests\TRS.MEMCFG.CHECK.001_2\\output\\result.log', "ERROR", ["Default_App_Ram_Implicit_RAR"]))

    def test_TRS_MEMCFG_CHECK_002_1(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.002_1\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_CHECK_002_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.002_2\\ConfigMemConfigurator.xml')
        ...
        self.assertTrue(FileCompare.checkLog(head + '\\tests\TRS.MEMCFG.CHECK.002_2\\output\\result.log', "ERROR", ["App_Ram_Implicit"]))

    def test_TRS_MEMCFG_CHECK_002_3(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.002_3\\ConfigMemConfigurator.xml')
        ...
        self.assertTrue(FileCompare.checkLog(head + '\\tests\TRS.MEMCFG.CHECK.002_3\\output\\result.log', "ERROR", ["Default_App_Ram_Implicit_RAR"]))

    def test_TRS_MEMCFG_CHECK_003_1(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.003_1\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_CHECK_003_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.003_2\\ConfigMemConfigurator.xml')
        ...
        self.assertTrue(FileCompare.checkLog(head + '\\tests\TRS.MEMCFG.CHECK.003_2\\output\\result.log', "ERROR", ["SR_ConsoAutonomieGM"]))
    ...
    def test_TRS_MEMCFG_CHECK_005_1(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_1\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_CHECK_005_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_2\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_CHECK_005_3(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_3\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_CHECK_005_4(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_4\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_CHECK_006_1(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.006_1\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_CHECK_006_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.CHECK.006_2\\ConfigMemConfigurator.xml')
        ...
        self.assertTrue(FileCompare.checkLog(head + '\\tests\TRS.MEMCFG.CHECK.004\\output\\result.log', "ERROR", ["Default_App_Ram_Implicit_RAR"]))

    def test_TRS_MEMCFG_GEN_001(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.GEN.001\\ConfigMemConfigurator.xml')
        self.assertTrue(FileCompare.NvDMStructure(head + '\\tests\\TRS.MEMCFG.GEN.001\\output\\NvDM.epc'))

    def test_TRS_MEMCFG_GEN_002_1(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.GEN.002_1\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_GEN_002_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.GEN.002_2\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_GEN_002bis(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.GEN.002bis\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_GEN_003_1(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.GEN.003_1\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_GEN_003_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.GEN.003_2\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_FUNC_004(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.FUNC.004\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_FUNC_005(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.FUNC.005\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_FUNC_006_1(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.FUNC.006_1\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_FUNC_006_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.FUNC.006_2\\ConfigMemConfigurator.xml')
    ...
    def test_TRS_MEMCFG_GEN_009(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.GEN.009\\ConfigMemConfigurator.xml')
        self.assertTrue(FileCompare.checkOrder(head + '\\tests\\TRS.MEMCFG.GEN.009\\output\\NvM.epc'))

    def test_TRS_MEMCFG_GEN_011(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.GEN.011\\ConfigMemConfigurator.xml')
        self.assertTrue(FileCompare.isOutput(head + '\\tests\\TRS.MEMCFG.GEN.011\\output\\NvDM.epc'))

    def test_TRS_MEMCFG_GEN_012(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\TRS.MEMCFG.GEN.012\\ConfigMemConfigurator.xml')
        self.assertTrue(FileCompare.isOutput(head + '\\tests\\TRS.MEMCFG.GEN.012\\output\\NvM.epc'))

    def test_CHECK_XML(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('MEM_Configurator.py -config ' + head + '\\tests\\CHECK.XML\\ConfigMemConfigurator.xml')
