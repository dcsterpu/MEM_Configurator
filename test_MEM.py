...
class MEMConfigurator(unittest.TestCase):
    ...
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.INOUT.001\\input -out ' + head + '\\tests\\TRS.MEMCFG.INOUT.001\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.INOUT.002\\input -out ' + head + '\\tests\\TRS.MEMCFG.INOUT.002\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.FUNC.001_1\\input -out ' + head + '\\tests\\TRS.MEMCFG.FUNC.001_1\\output -alignment 4')
    #     self.assertTrue(FileCompare.areSorted(head + '\\tests\\TRS.MEMCFG.FUNC.001_1\\output\\NvDM.epc'))
    #
    # def test_TRS_MEMCFG_FUNC_001_2(self):
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.FUNC.001_2\\input -out ' + head + '\\tests\\TRS.MEMCFG.FUNC.001_2\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.FUNC.002_1\\input -out ' + head + '\\tests\\TRS.MEMCFG.FUNC.002_1\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.FUNC.002_2\\input -out ' + head + '\\tests\\TRS.MEMCFG.FUNC.002_2\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.001_1\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.001_1\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.001_2\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.001_2\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in @' + head + '\\tests\\TRS.MEMCFG.CHECK.002_2\\input_list.txt -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.002_2\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.002_3\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.002_3\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.003_1\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.003_1\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.003_2\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.003_2\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.004\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.004\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_1\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_1\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_2\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_2\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_3\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_3\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_4\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.005_4\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.006_1\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.006_1\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.006_2\\input -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.006_2\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.001\\input -out ' + head + '\\tests\\TRS.MEMCFG.GEN.001\\output -alignment 4')
    #     self.assertTrue(FileCompare.NvDMStructure(head + '\\tests\\TRS.MEMCFG.GEN.001\\output\\NvDM.epc'))
    #
    # def test_TRS_MEMCFG_GEN_002_1(self):
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.002_1\\input -out ' + head + '\\tests\\TRS.MEMCFG.GEN.002_1\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.002_2\\input -out ' + head + '\\tests\\TRS.MEMCFG.GEN.002_2\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.002bis\\input -out ' + head + '\\tests\\TRS.MEMCFG.GEN.002bis\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.003_1\\input -out ' + head + '\\tests\\TRS.MEMCFG.GEN.003_1\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.003_2\\input -out ' + head + '\\tests\\TRS.MEMCFG.GEN.003_2\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.FUNC.004\\input -out ' + head + '\\tests\\TRS.MEMCFG.FUNC.004\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.FUNC.005\\input -out ' + head + '\\tests\\TRS.MEMCFG.FUNC.005\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.FUNC.006_1\\input -out ' + head + '\\tests\\TRS.MEMCFG.FUNC.006_1\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.FUNC.006_2\\input -out ' + head + '\\tests\\TRS.MEMCFG.FUNC.006_2\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.008\\input -out ' + head + '\\tests\\TRS.MEMCFG.GEN.008\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.009\\input -out ' + head + '\\tests\\TRS.MEMCFG.GEN.009\\output -alignment 4')
    #     self.assertTrue(FileCompare.checkOrder(head + '\\tests\\TRS.MEMCFG.GEN.009\\output\\NvM.epc'))
    #
    # def test_TRS_MEMCFG_GEN_011(self):
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.011\\input -out ' + head + '\\tests\\TRS.MEMCFG.GEN.011\\output -alignment 4')
    #     self.assertTrue(FileCompare.isOutput(head + '\\tests\\TRS.MEMCFG.GEN.011\\output\\NvDM.epc'))
    #
    # def test_TRS_MEMCFG_GEN_012(self):
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.012\\input -out ' + head + '\\tests\\TRS.MEMCFG.GEN.012\\output -alignment 4')
    #     self.assertTrue(FileCompare.isOutput(head + '\\tests\\TRS.MEMCFG.GEN.012\\output\\NvM.epc'))
    #
    # def test_CHECK_XML(self):
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\CHECK.XML\\input -out ' + head + '\\tests\\CHECK.XML\\output -alignment 4')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TBD\\input -out ' + head + '\\tests\\TBD\\output -alignment 4')
    #     self.assertTrue(FileCompare.checkID(head + '\\tests\\TBD\\output\\NvM.epc'))
    #
    # def test_TBD_2(self):
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TBD_2\\input -out ' + head + '\\tests\\TBD_2\\output -alignment 4')
    ...
    #
    # def test_TRS_MEMCFG_GEN_015_1(self):
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.015_1\\in -out ' + head + '\\tests\\TRS.MEMCFG.GEN.015_1\\out -in_resizing ' + head +'\\tests\\TRS.MEMCFG.GEN.015_1\\overload -alignment 4')
    #     self.assertTrue(FileCompare.areSame(head + '\\tests\\TRS.MEMCFG.GEN.015_1\\out\\NvDM.epc', head + "\\tests\\TRS.MEMCFG.GEN.015_1\\expected_NvDM.epc"))
    #
    # def test_TRS_MEMCFG_CHECK_013_1(self):
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.013_1\\in -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.013_1\\out -alignment 4')
    #     self.assertFalse(FileCompare.isOutput(head + '\\tests\\TRS.MEMCFG.CHECK.013_1\\out\\NvM.epc'))
    #     self.assertTrue(FileCompare.checkLog(head + '\\tests\\TRS.MEMCFG.CHECK.013_1\\out\\result_MEM.log', "ERROR", ["different callbacks"]))
    #
    def test_TRS_MEMCFG_CHECK_013_2(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.CHECK.013_2\\in -out ' + head + '\\tests\\TRS.MEMCFG.CHECK.013_2\\out -alignment 4')
        self.assertTrue(FileCompare.areSame(head + '\\tests\\TRS.MEMCFG.CHECK.013_2\\out\\NvM.epc', head + "\\tests\\TRS.MEMCFG.CHECK.013_2\\expected_NvM.epc"))
    #
    # def test_TRS_MEMCFG_GEN_018_1(self):
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('coverage run MEM_Configurator.py -in ' + head + '\\tests\\TRS.MEMCFG.GEN.018_1\\in -out ' + head + '\\tests\\TRS.MEMCFG.GEN.018_1\\out -alignment 4')
    #     self.assertTrue(FileCompare.areSame(head + '\\tests\\TRS.MEMCFG.GEN.018_1\\out\\NvM.epc', head + "\\tests\\TRS.MEMCFG.GEN.018_1\\expected_NvM.epc"))
